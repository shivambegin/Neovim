return {
    {
        ...
        config = function()
            ...
            local colors = require 'amahmod.plugins.feline.colors'
            local hl = require('amahmod.plugins.feline.helpers').hl
            local pp = require('amahmod.plugins.feline.helpers').provider
            local conditional =
                require('amahmod.plugins.feline.helpers').conditional
